...
public class CarDriver {
	...
	public static void main(String[] args) {
		...
		System.out.println("Cars made: " + Car.getCount());
		System.out.println(car1.toString() + "\n");
		...
		car2.setColor("dark grey");
		car2.setEngineSize("V16");
		car2.setHorsePower(900);
		car2.setMaker("Fine Autos");
		System.out.println("\nCars 2 and 3 match: " + car3.equals(car2));
	}
